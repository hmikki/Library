        ...
        <div class="row mt-50 px-20">
            @foreach($value->{$Field['entity']} as $media)
                <span style="position: relative;width: 120px;height: 120px;display: inline-block">
                    <a href="{{url('dashboard/delete/media?media_id='.$media->id)}}" class="text-danger" style="position: absolute;top: 5px;right: 10px;"><i class="text-danger fa fa-window-close"></i></a>
