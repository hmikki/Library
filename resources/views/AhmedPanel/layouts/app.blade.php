...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('favicon.jpeg')}}" />
...
<div class="wrapper">
    ...
    <div class="sidebar" data-color="{{ config('app.color') }}" data-image="">
        <div class="logo" style="text-align: center;">
            <img onclick="window.location ='{{url('/dashboard')}}'" src="{{asset((app()->getLocale()=='ar')?'logo.jpeg':'logo.jpeg')}}" style="cursor: pointer" alt="" width="70px" height="70px">
        </div>
                ...
                <div class="collapse navbar-collapse" >
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            ...
                            <a href="{{route('dashboard.logout')}}" style="display: inline-block;" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
