...
<div class="wrapper">
    <div class="container-fluid">
        <header>
            <nav id="navbar" class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                    <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('logo.jpeg')}}" alt="" width="70px" height="70px"></a>
    ...
    <footer>
        <div class="bg-img-footer"><img src="{{asset('assets/img/logo.jpeg')}}" alt="" width="70px"></div>
        <div class="container">
            <div class="row">
                <div class="col-12 p-0">
                    ...
                    <div class="footer-content">
                        <div class="row responsive">
                            <div class="col-md-4 col-12"> <img src="{{asset('assets/img/logo.jpeg')}}" alt="" width="70px"> </div>
                            <div class="col-md-4 col-12">
                                <ul class="footer-list">
                                    <li><a href="#">support@official.com</a></li>
                                    <li>Sanaa, Yemen, 11253</li>
                                </ul>
                            </div>
                        </div>
                        <div class="row responsive">
                            <div class="col-md-4"></div>
                            <div class="col-md-2 col-6"><a href="{{url('about')}}" class="footer-link">About</a></div>
